...
const Navbar = () => {
  ...
  return (
    <nav className='w-full flex my-6 justify-between items-center navbar' >
      ...
      <div className={`${toggle ? 'flex' : 'hidden'} p-6 bg-black-gradient absolute top-20 right-0 mx-4 my-2 min-w-[104px] rounded-xl sidebar `}>
